...
{
    static const touchgfx::FontId DEFAULT = 0;       // seguisb_22_4bpp
    static const touchgfx::FontId LARGE = 1;         // verdana_40_4bpp
    static const touchgfx::FontId SMALL = 2;         // verdana_10_4bpp
    static const touchgfx::FontId TYPOGRAPHY_00 = 3; // ROCK_TTF_99_4bpp
    static const touchgfx::FontId TYPOGRAPHY_01 = 4; // ROCK_TTF_26_4bpp
